...
I imagine the performance of the Pixi'VN and the library used by Ren'Py to be almost the same, but the performance of the Canvas used by the two libraries is very significant.

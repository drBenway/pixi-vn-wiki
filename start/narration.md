...
You have the option to use various types of narrative languages (thanks to the [PixiVNJson](/advanced/pixi-vn-json.md)). You can also switch from one language to another to take advantage of the features of each one.

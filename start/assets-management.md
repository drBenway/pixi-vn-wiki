...
Initialize the asset matrix at the start of the project, this will allow you to refer to the assets by a unique alias and not by a url. This way you can use its alias (instead of url/path) and you can change the URL of a resource without having to worry about the compatibility of old saves.
